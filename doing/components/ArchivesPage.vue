...
.theme-style-line
  .archives-page .theme-doing-wrapper
    box-shadow 0 0
    // border 1px solid var(--borderColor)
    // border-radius 5px
.archives-page
  .theme-doing-wrapper
    @extend $doing-wrapper
    position relative
    ...
    .loadmore
      ...
      margin-top 1rem
      opacity 0.5
.theme-mode-dark .archives-page .theme-doing-wrapper li a:hover, .theme-mode-read .archives-page .theme-doing-wrapper li a:hover
